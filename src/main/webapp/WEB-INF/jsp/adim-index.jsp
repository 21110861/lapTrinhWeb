...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<c:url value='/admin-index.jsp' />">Start Bootstrap</a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<c:url value='/admin-index.jsp' />">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="<c:url value='/layout-static.html' />">Static Navigation</a>
                                <a class="nav-link" href="<c:url value='/layout-sidenav-light.html' />">Light Sidenav</a>
                            </nav>
                        </div>
                        ...
                        <c:forEach var="i" begin="1" end="3">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Primary Card ${i}</div>
