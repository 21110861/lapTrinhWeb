    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
            ...
            <head>
                ...
                <c:set var="relativePath" value="${fn:substringAfter(requestURI, contextPath)}" />
                                    ...
                                    <div class="header__top__inner">
                                        <div class="header__top__left">
                                            <ul>
                                                <c:if test="${empty sessionScope.user}">
                                                    <li><a href="/login">Sign in</a> <span
                                                            class="arrow_carrot-down"></span>
                                                    </li>
                                                </c:if>
                                                <c:if test="${not empty sessionScope.user}">
                                                    <li>
                                                        <a>Welcome, ${sessionScope.user}! </a> <span
                                                            class="arrow_carrot-down"></span>
                                                        <ul>
                                                            <li>Cá Nhân</li>
                                                            ...
                                                            <c:if test="${sessionScope.isAdmin}">
                                                                ...
                                                                <li><a href="/admin" style="color: white;">Quản Lý</a>
                                                                </li>
                                                            </c:if>
                                                        </ul>
                                                    </li>
                                        ...
                                        <div class="header__top__right">
                                            ...
                                            <div class="header__top__right__cart">
                                                <a href="/giohang"><img src="<c:url value=" /img/icon/cart.png" />"
                                                    alt="">
